...
- (void)drawRect:(CGRect)rect
{
    ...
    [self drawPolygon:points];//先填充颜色,再划线
    
    [[UIColor redColor] setFill];
    
    //画波浪线
    [self drawCurveFrom:CGPointMake(100, 50)
                     to:CGPointMake(220, 50)
          controlPoint1:CGPointMake(100, 0)
          controlPoint2:CGPointMake(190, 100)];//起点,重点,中间点
